/*@ begin PerfTuning (
  ...
  def search
  {
    ...
    arg dlmt_linear = '["T1_I", "T1_J", "T1_Ia", "T1_Ja", "U1_I", "U1_J", "RT1_I", "RT1_J", "SCR", "VEC1", "OMP"]';
    arg dlmt_quadratic = '["T1_I", "T1_J", "T1_Ia", "T1_Ja", "U1_I", "U1_J", "RT1_I", "RT1_J"]';
    arg dlmt_cubic = '["T1_I", "T1_J", "T1_Ia", "T1_Ja", "U1_I", "U1_J", "RT1_I", "RT1_J"]';
  }
