...
/*@ begin PerfTuning (
  ...
  def search
  {
    ...
    arg dlmt_linear = '["T1_I", "T1_J", "T2_I", "T2_J", "ACOPY_A", "U_I", "U_J", "SCREP", "VEC", "OMP", "PAR1i", "PAR1j"]';
    arg dlmt_quadratic = '["T1_I", "T1_J", "T2_I", "T2_J", "U_I", "U_J"]';
    arg dlmt_cubic = '["T1_I", "T1_J", "T2_I", "T2_J", "U_I", "U_J"]';
  }
