...
/*@ begin PerfTuning (
  ...
  def performance_params
  {
    ...
    param T5_I[] = [1,2,4,8,16,32,64,128,256,512,1024,2048];
    param T5_J[] = [1,2,4,8,16,32,64,128,256,512,1024,2048];
    param T5_Ia[] = [1,2,4,8,16,32,64,128,256,512,1024,2048];
    param T5_Ja[] = [1,2,4,8,16,32,64,128,256,512,1024,2048];
    param T7_I[] = [1,2,4,8,16,32,64,128,256,512,1024,2048];
    param T7_J[] = [1,2,4,8,16,32,64,128,256,512,1024,2048];
    param T7_Ia[] = [1,2,4,8,16,32,64,128,256,512,1024,2048];
    param T7_Ja[] = [1,2,4,8,16,32,64,128,256,512,1024,2048];
    ...
    param RT5_I[] = [1,2,4,8,16,32];
    param RT5_J[] = [1,2,4,8,16,32];
    param RT7_I[] = [1,2,4,8,16,32];
    param RT7_J[] = [1,2,4,8,16,32];
  ...
  def search
  {
    ...
    arg gpr_extra_experiments = 5;
    arg gpr_steps = 45;
    arg gpr_failure_multiplier = 20000;
  }
